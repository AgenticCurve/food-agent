...
function setupCommands(bot: TelegramBot, openrouterKey: string): void {
  ...
  bot.onText(/\/help/, (msg) => {
    ...
    const help = [
      "**Food Agent**",
      "Your personal health & nutrition tracker. Just chat naturally — I understand plain language.",
      "",
      "━━━━━━━━━━━━━━━━━━━━",
      "**What I can track**",
      "━━━━━━━━━━━━━━━━━━━━",
      ...
      "",
      "😴 **Sleep** — tell me when you slept",
      '   "slept 11pm to 7am, quality 8"',
      '   "took a 30 min nap at 2pm"',
      "",
      "⚖️ **Weight** — just tell me your weight",
      '   "72.5 kg today"',
      "",
      "📝 **Notes** — save any observation",
      '   "note: feeling low energy today"',
      '   "note: started creatine"',
      "",
      "🏷 **Nutrition labels** — send a photo",
      "   I'll extract and save the nutrition profile (per 100g) for future reference.",
      "",
      "👤 **Profile** — persistent facts about you",
      '   "remember I\'m vegetarian"',
      '   "I\'m allergic to peanuts"',
      '   "I\'m lactose intolerant"',
      "   I'll keep these in mind for every conversation.",
      "",
      "📷 **Photos** — send photos of food, products, labels, or menus",
      ...
      "━━━━━━━━━━━━━━━━━━━━",
      "",
      "Entries are numbered #1, #2, etc. per day.",
      '• "change #2 to 3 eggs"',
      '• "remove #1"',
      '• "#3 was actually 200 cal"',
      '• "delete the toast"',
      "",
      "━━━━━━━━━━━━━━━━━━━━",
      "📊 **Data commands**",
      "━━━━━━━━━━━━━━━━━━━━",
      "",
      "View your data — add a question for specific queries:",
      '   e.g. `/today how much protein?`',
      '   e.g. `/nutrition do I have goat cheese?`',
      "",
      "🍽 /today — today's food log",
      "📅 /week — this week's food summary",
      "😴 /sleep — recent sleep entries",
      "📝 /notes — this week's notes",
      "⚖️ /weight — weight history",
      "🏷 /nutrition — saved nutrition profiles",
      "👤 /profile — your preferences & restrictions",
      "",
      "━━━━━━━━━━━━━━━━━━━━",
      "⚙️ **Settings & tools**",
      "━━━━━━━━━━━━━━━━━━━━",
      ...
      "↩️ /undo — remove the last food entry",
